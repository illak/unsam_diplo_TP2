...
Podemos observar que existen un mayor (pero no tanto) porcentaje de noticias del
tópico 8.
...
Acá es notable que las noticias del medio "cronica" son mayormente del tema o tópico
10 el cual habla de (según creo yo) de casos de violencia de genero, pero no estoy tan
seguro...

```{r}

#TODO: me parece que hay que reducir la cantidad de tópicos para el LDA, probar con 6!
